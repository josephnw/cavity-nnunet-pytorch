...
5) (OPTIONAL) Install [hiddenlayer](https://github.com/waleedka/hiddenlayer). hiddenlayer enables nnU-net to generate
   ...
   run the following commands:
    ...
    ```
- (IMPORTANT) before installing hiddenlayer uninstall existing hiddenlayer:

  - uninstall hiddenlayer `pip uninstall hiddenlayer`
  - uninstall ipython (if installed) `pip uninstall ipython`

  - a known issue (conda and pip conflict):
    - https://github.com/pypa/pip/issues/8676#issuecomment-693961214
